---
title: An Opinion on PWA's (Progressive Web Apps)
description: PWA stands for progressive web app, which is used to deliver a
  native like experience, however it also has some advantages and disadvantages.
author: MD Saifullah
...
- Advantages
  ...
  - Cross-Platform: They work across different browsers and systems with minimal functionality difference.
No App Store Required: PWAs don't need users to sign up for any specific store, however some of the PWAs are also available on some app stores.
- Disadvantages
